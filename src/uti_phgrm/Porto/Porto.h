...
private:
    // ADDED BY GABRIEL - header additions
    Tiff_Im *GetPerImMaskFile(int aGlobIndex);
    void SauvPerImageMasks();
    std::vector<Tiff_Im *> mPerImMaskFiles;
    bool mGenMasks;
    std::string mMaskOutDir;
